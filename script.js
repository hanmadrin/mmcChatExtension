    ...
    collectUnseenMessage: async()=>{
        ...
        if(window.location.href==fixedData.workingUrls.messages){
            ...
            while(true){
                ...
                const lastMessageTimeObject = allUnseenMessages!=null?allUnseenMessages[allUnseenMessages.length-1].querySelector(fixedData.workingSelectors.messages.timeStamp).getAttribute('data-store'):'{time:0}';
